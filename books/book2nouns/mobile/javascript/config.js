...
bookConfig.macBookVersion = "MCXemvJGcbsqCATclqNDZXnjJBWepvFDRXupGPTcgnPGRairGCfbpnAHVYrsAKXRpnDHQYvhDHcWijIPRdorKBZVqtGBbZjkGEfYigLAfRljKHSYvjFGRdnjFOQVvuBPUdrmFLdWrtAEZcgsGMWYrrOKUaqladAFa1a3_";
...
bookConfig.largePageWidth=507;
bookConfig.largePageHeight=649;
bookConfig.bookTitle="English For Everyone - Nouns";
bookConfig.normalPath="./files/mobile/";
bookConfig.largePath="./files/mobile/";
bookConfig.productName="Any Flip";
bookConfig.useTheAliCloudChart=false;
bookConfig.MidBgColor="#e314a4";
bookConfig.bookmarkCR = "9999c027aece3b376fa74db6c4d74d0c818d921c";
