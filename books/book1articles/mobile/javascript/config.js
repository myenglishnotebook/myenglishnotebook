...
bookConfig.macBookVersion = "IITZglPNfcprKHYVmtNPceurGBcZolMIdQmsFEfRjsBBaVhjLBfQktEGXdnnKPeQioLCXRvjJNRShmOFVcsoFFaUirKFVTuvJORaqvOIRUhrLLZSukLOZdhsFJXbrsJPQVjgBOZfnrMGWfvtIOdZriKBfW4Fba4886_";
bookConfig.Html5Template = "Metro";
bookConfig.UIBaseURL="mobile/";
bookConfig.isFlipPdf=false;
bookConfig.searchTextJS="mobile/javascript/search_config.js";
bookConfig.totalPageCount=18;
bookConfig.largePageWidth=464;
bookConfig.largePageHeight=603;
bookConfig.bookTitle="English Learning - Articles";
bookConfig.normalPath="./files/mobile/";
bookConfig.largePath="./files/mobile/";
bookConfig.productName="Any Flip";
bookConfig.useTheAliCloudChart=false;
bookConfig.MidBgColor="#8d6b4b";
bookConfig.bookmarkCR = "42988a0f526abc24ba2f1014898b0db1dd328f02";
